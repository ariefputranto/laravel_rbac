...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-12">
      ...
      @endif
      <center><h1>Summary Transaction</h1></center><br>
      <div class="row">
      	<div class="col-md-3">
	      	<div class="card card-body bg-primary text-white">
						<div class="row" style="line-height: 1.2;">
							...
							<div class="col-md-8">
								<span class="font-weight-bold" style="font-size: 40px">{{ $count_transactions }}</span>
	      ...
	      <div class="col-md-3">
	      	<div class="card card-body bg-success text-white">
						<div class="row" style="line-height: 1.2;">
							...
							<div class="col-md-8">
								<span class="font-weight-bold" style="font-size: 40px">{{ number_format($total_price / 1000) }}K</span>
	      ...
	      <div class="col-md-3">
	      	<div class="card card-body bg-danger text-white">
						<div class="row" style="line-height: 1.2;">
							...
							<div class="col-md-8">
								<span class="font-weight-bold" style="font-size: 40px">{{ $count_product }}</span>
								<h6><b>Product</b></h6>
							</div>
						</div>
					</div>
	      ...
	      <div class="col-md-3">
	      	<div class="card card-body bg-info text-white">
						<div class="row" style="line-height: 1.2;">
							...
							<div class="col-md-8">
								<span class="font-weight-bold" style="font-size: 40px">{{ $total_product }}</span>
